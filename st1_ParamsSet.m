...
% Modify these values to use ROI indices that exist in your dataset
% Using ROIs that are within the bounds of your dataset (< 90)
sdph{1}={18; 45}; sdph{2}={45; 72}; sdph{3}={18; 72}; sdph(4:5)={{18}}; 
